...
const loginFormPhone = document.querySelector('#login-form-phone');
...
loginFormEmail.addEventListener('submit', async (event) => {
...
loginFormOtp.addEventListener('submit', async (event) => {
    event.preventDefault();
    const phone = loginFormPhone.querySelector('#phone').value;
